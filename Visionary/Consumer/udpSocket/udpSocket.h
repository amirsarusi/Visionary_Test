...
#ifndef CONSUMER_UDPSOCKET_H
#define CONSUMER_UDPSOCKET_H
...
public:
     ...
     */
    void sendTo(const void *buffer, int bufferLen, const std::string &foreignAddress,unsigned short foreignPort) noexcept(false);
